...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-white dark:bg-black transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-b border-gray-200 dark:border-gray-800">
          <div className="p-8 md:p-12 border-r border-gray-200 dark:border-gray-800">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-8">
              Let's collaborate on something great. Reach out through any of these channels.
            </p>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-mono text-xs text-gray-500 dark:text-gray-600">Email</span>
                </div>
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-mono text-xs text-gray-500 dark:text-gray-600">GitHub</span>
                </div>
                <div className="text-sm text-black dark:text-white font-semibold">
                  @yourusername
                </div>
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-mono text-xs text-gray-500 dark:text-gray-600">LinkedIn</span>
                </div>
                <div className="text-sm text-black dark:text-white font-semibold">
                  @yourusername
                </div>
          ...
          <div className="p-8 md:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-xs font-mono text-gray-500 dark:text-gray-600 mb-2 tracking-wider">
                  NAME
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-xs font-mono text-gray-500 dark:text-gray-600 mb-2 tracking-wider">
                  EMAIL
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="block text-xs font-mono text-gray-500 dark:text-gray-600 mb-2 tracking-wider">
                  MESSAGE
                </label>
                <textarea
                  id="message"
        ...
        <div className="p-8 md:p-12 border-t border-gray-200 dark:border-gray-800 text-center">
